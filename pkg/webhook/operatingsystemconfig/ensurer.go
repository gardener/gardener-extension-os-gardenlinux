...
func (e *ensurer) EnsureContainerdConfig(ctx context.Context, gctx extensionscontextwebhook.GardenContext, new, _ *extensionsv1alpha1.CRIConfig) error {
...
func ensureContainerdUsesSystemdCgroupDriver(containerdConfig *extensionsv1alpha1.CRIConfig) error {
	containerdConfig.CRICgroupDriver = extensionsv1alpha1.CRICgroupDriverSystemd
	return nil
}
